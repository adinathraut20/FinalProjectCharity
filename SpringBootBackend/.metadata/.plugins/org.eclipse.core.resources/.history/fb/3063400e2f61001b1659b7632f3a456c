...
import com.povertyFree.povertyLessIndia.dto.PaytmDetailPojo;
...
public class PaymentController {
	...
	@Autowired
	private Environment env;  //envirment variable part of spring framework---purpose to get the value from application properties
	...
	public String home() {
	 ...
	 @PostMapping(value = "/submitPaymentDetail")
	    public TreeMap<String, String> getRedirect(@RequestParam(name = "CUST_ID") String customerId,
	...
	private String getCheckSum(TreeMap<String, String> parameters) throws Exception {
		...
		//paytmchecksum predefined class
		
		//predefined method present in paytmcheck-sum class  which is present in line no 18 package
	}
